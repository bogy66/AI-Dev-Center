...
const helpSlides = [
    ...
    },
    {
        ...
        html: () => `
            ...
            <p>After an approved setup has executed successfully, the canonical flow can continue through development, structured test changes, controlled application, real tests and diagnosis. Real test results take priority over diagnosis: a Diagnosis Reviewer can describe failures and create structured rework, but cannot approve a failed or timed-out run. There is no automatic rework loop, Git or publish step here; accepted is not publication, and existing project conventions remain respected.</p>
