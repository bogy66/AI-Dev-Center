...
const helpSlides = [
    ...
    },
    {
        ...
        html: () => `
            ...
            <p>After an approved setup has executed successfully, the canonical flow can continue through development, structured test changes, controlled application, real tests and diagnosis. Real test results take priority over diagnosis: a structured rework request may trigger exactly one controlled rework cycle, which is applied and tested again; another rework-required result ends the run. There is no unlimited retry, Git or publish step here; accepted is not publication, and existing project conventions remain respected.</p>
